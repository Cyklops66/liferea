...
pkglibexecdir = $(libexecdir)/liferea
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(dist_data_convert_DATA) \
	$(am__DIST_COMMON)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_HEADER = config.h
CONFIG_CLEAN_FILES = net.sf.liferea.gschema.xml
...
net.sf.liferea.gschema.xml: $(top_builddir)/config.status $(srcdir)/net.sf.liferea.gschema.xml.in
